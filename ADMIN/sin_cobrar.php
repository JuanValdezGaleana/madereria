...
$csinCobrar=mysql_query("
						SELECT CVE_VENTA, ID_VENTA_SALIDA, FECHA FROM ventas_salidas
						WHERE ID_ESTATUS_VENTA=3 
						AND ID_ESTABLECIMIENTO=$id_establecimiento
						GROUP BY CVE_VENTA DESC;
						")
...
<tr class="bgtabla">
  <td width="13%" align="center">&nbsp;</td>
    ...
    <td width="19%" align="center">CLAVE DE VENTA</td>
...
<?php  
	...
	while($dsinCobrar=mysql_fetch_array($csinCobrar)){
?>
  
  <tr class="hover_lista">
    <td>&nbsp;</td>
    <td align="center"><?php $date = $dsinCobrar['FECHA'];echo fechaesp($date)."-"; echo "-".date("H:i:s",strtotime($dsinCobrar['FECHA']))." HR."; ?></td>
    <td align="center"><?php echo $dsinCobrar['CVE_VENTA'];  ?></td>
    <td align="center"><a href="detalle_nota.php?cv=<?php echo $dsinCobrar['CVE_VENTA']; ?>" style="text-decoration:none; color:#000;">
    <div class="fondo stretchLeft" ><div class="iconos_lista" style="text-decoration:underline; color:red;" >VER NOTA DE VENTA</div></div>
    </a>
