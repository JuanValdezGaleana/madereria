...
/*echo '1>'.$descripcion."<br>";
echo '1>'.$nombre."<br>";*/
$descripcion=str_replace("'","\'",$descripcion);
$nombre=str_replace("'","\'",$nombre);
/*echo '2>'.$descripcion."<br>";
echo '2>'.$nombre."<br>";*/
...
$updinventario=mysql_query("
UPDATE inventario SET CANTIDAD_ACTUAL=$cant_act WHERE ID_PRODUCTO=$id_producto
")
or die("No se pudo actualizar la cantidad de productos en el inventario.<br />".mysql_error());
