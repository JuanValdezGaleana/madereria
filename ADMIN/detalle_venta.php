...
switch($r){
	case 1:
	?>
	<a href="index.php"><img src="../imagenes/back.png"/></a>
    <?php
	break;
	case 2:
	$f1=$_GET['f1'];
	...
	$o=$_GET['o'];
	?>
	<a href="index.php?f1=<?php echo $f1; ?>&f2=<?php echo $f2; ?>&grupo=<?php echo $g; ?>&orden=<?php echo $o; ?>"><img src="../imagenes/back.png"/></a>
    <?php
	break;
	case 3:
	$f1=$_GET['f1'];
	...
	?>
	<a href="index.php?idp=<?php echo $idp; ?>"><img src="../imagenes/back.png"/></a>
    <?php
	break;
	...
	?>
	<a href="index.php?idp=<?php echo $idp; ?>&f1=<?php echo $f1; ?>&f2=<?php echo $f2; ?>"><img src="../imagenes/back.png"/></a>
    <?php
	break;
