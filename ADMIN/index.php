        ...
        <div class="dropdown_3columns align_right"><!-- Begin 3 columns container -->
             <div class="col_1">
                <ul class="greybox">
                	 ...
                	 <li><a href="detalle_tp.php">s</a></li>
...
<table width="100%" height="48px" border="0">
  <tr>
    ...
    <input type="date" name="fecha_inicio"   size="12" id="fecha_inicio">
    </td>
    <td width="8%" align="right" valign="middle">HASTA:</td>
    <td width="27%" valign="middle">
    <input type="date" name="fecha_fin"  size="12" id="fecha_fin">
    </td>
...
?>  </td>
    ...
    <input name="enviar" type="submit" value="Generar reporte de ventas" class="boton_verde" />
    </form>
    </td>
  </tr>
</table>
...
if($dTicket['ESTATUS_VENTA']=='SIN COBRAR' || $dTicket['ESTATUS_VENTA']=='DEVOLUCION'){$color='style="color:#F00"';}?>
  ...
  <tr class="hover_lista">
    ...
    <td ><a href="detalle_venta.php?cv=<?php echo $dTicket['CVE_VENTA']; ?>&r=3&f1=<?php echo $fInicioAx; ?>&f2=<?php echo $fFinAx;?>&g=<?php echo $grupo; ?>&o=<?php echo $orden; ?>" style="text-decoration:none; color:#000;"><div class="fondo stretchLeft"><div class="iconos_lista">DETALLE</div></div></a></td>
     <td ><a href="fn.php?cve=<?php echo $dTicket['CVE_VENTA']; ?>" target="_blank" style="text-decoration:none; color:#000;"><div class="fondo stretchLeft"><div class="iconos_lista">IMPRIMIR</div></div></a></td>
  </tr>
<?php 
...
echo' 
	<a href="envio_correo.php?f1='.$fInicio.'&f2='.$fFin.'">
		<div class="bot_mod">ENVIAR CORREO</div>
	</a>	
 ';
 } ?>
