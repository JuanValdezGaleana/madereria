...
<a href="index.php"><div class="items_surtir slideDown ">POR TIPO</div></a>
...
/*	SUM(B.PRECIO_FINAL) AS TOT,*/
  C.ESTATUS_VENTA,
  /*D.TIPO_PRES_PROD,*/
SUM(IF(D.TIPO_PRES_PROD='A GRANEL',(A.PRECIO_VENTA),IF(D.TIPO_PRES_PROD='RECARGA',A.CANTIDAD_VEN*B.PRECIO_FINAL,A.PRECIO_VENTA) ) )AS TOT
