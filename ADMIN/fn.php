...
<tr>
  ...
  FECHA DE VENTA: <?php echo $datvent['FECHA'];  ?> <br />
  CVE. VENTA <?php echo $datvent['CVE_VENTA']; ?>
  </td>
</tr>
<tr>
  <td colspan="3" align="left"><strong><center>PINTU SAYER</center></strong></td>
</tr>
<tr>
  <td>CANT.</td>
    <td>DESCRIPCIÓN</td>
...
or die("No se pudo hacer la consulta.<br/>".mysql_error());
  ...
  <tr>
   ...
   <tr>
    <td colspan="3" align="center">TELEFONOS: 7131130695 Y 7131330060</td>
  </tr>
  <tr>
    <td colspan="3" align="center">MAIL: pintusayer.santiagot@gmail.com</td>
  </tr>
  <tr>
