...
INNER JOIN asoc_areas_puestos C
ON A.ASOC_AREA_PUESTO=C.ASOC_AREA_PUESTO
INNER JOIN cat_areas D
ON C.ID_AREA=D.ID_AREA
INNER JOIN cat_puesto E
ON C.ID_PUESTO=E.ID_PUESTO
INNER JOIN cat_estatus_activo F
ON C.ID_ESTATUS_ACTIVO=F.ID_ESTATUS_ACTIVO
INNER JOIN cat_estatus_activo G
ON B.ID_ESTATUS_ACTIVO=G.ID_ESTATUS_ACTIVO
AND G.ESTATUS_ACTIVO='ACTIVO'
...
<div class="surtir_tit stretchRight"><strong>MODIFICAR AREA Y PUETO DE <?php echo $res_datos[NOMBRE]." ".$res_datos[AP_PATERNO]." ".$res_datos[AP_MATERNO];?></strong></div>
...
<table width="100%" border="0">
  <tr>
    <td width="50%" align="right" valign="middle" >ÁREA DE TRABAJO ACTUAL: </td>
    <td width="50%" align="left" valign="middle"><?php echo $res_datos[AREA]; ?></td>
  </tr>
  <tr>
    <td width="50%" align="right" valign="middle">PUESTO DE TRABAJO ACTUAL: </td>
    <td width="50%" align="left" valign="middle"><?php echo $res_datos[PUESTO]; ?></td>
  </tr>
</table>

<form name="form1" method="post" action="modificar_area_puesto.php?emp_id=<?php echo $emp_id; ?>">
...
action="update_area_puesto.php?emp_id=<?php echo $emp_id; ?>&area_id=<?php echo $area_id; ?>">
<?php
	if($area_id!=0){
 ?>
  <table width="100%" border="0">
