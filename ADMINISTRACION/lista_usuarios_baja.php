...
<div class="surtir_tit stretchRight"><strong>USUARIOS DADOS DE BAJA</strong></div>
<div class="espacio_calendario">
<a href="lista_usuarios_baja.php"><div class="items_surtir2 slideDown item_surtir_sel">USUARIOS BAJA</div></a>
<a href="lista_usuarios.php"><div class="items_surtir2 slideDown">USUARIOS ACTIVOS</div></a>
</div>
</div>
</div>
...
?>
  <table width="100%" class="tabla_usuarios">
    <tr>
      <td width="15%" align="center" valign="middle" class="bgtabla"><span class="tabla_encabezado">USUARIO</span>
      <a href="lista_usuarios_baja.php?grupo=<?php echo "A.NOMBRE_USSER"; ?>&orden=<?php echo "ASC"; ?>"><img class="flechas_ordenar_arriba"  src="../imagenes/ordena_arriba2.png" /></a>
        <a href="lista_usuarios_baja.php?grupo=<?php echo "A.NOMBRE_USSER"; ?>&orden=<?php echo "DESC"; ?>"><img class="flechas_ordenar_abajo" src="../imagenes/ordena_abajo2.png"  /></a> 
      </td>
      <td width="15%" align="center" valign="middle" class="bgtabla"><span class="tabla_encabezado">CLAVE</span>
	<a href="lista_usuarios_baja.php?grupo=<?php echo "B.CUE"; ?>&orden=<?php echo "ASC"; ?>"><img class="flechas_ordenar_arriba"  src="../imagenes/ordena_arriba2.png" /></a>
        <a href="lista_usuarios_baja.php?grupo=<?php echo "B.CUE"; ?>&orden=<?php echo "DESC"; ?>"><img class="flechas_ordenar_abajo" src="../imagenes/ordena_abajo2.png"  /></a>
      </td>
      <td width="36%" align="center" valign="middle" class="bgtabla"><span class="tabla_encabezado">NOMBRE</span>
      <a href="lista_usuarios_baja.php?grupo=<?php echo "B.AP_PATERNO"; ?>&orden=<?php echo "ASC"; ?>"><img class="flechas_ordenar_arriba"  src="../imagenes/ordena_arriba2.png" /></a>
        <a href="lista_usuarios_baja.php?grupo=<?php echo "B.AP_PATERNO"; ?>&orden=<?php echo "DESC"; ?>"><img class="flechas_ordenar_abajo" src="../imagenes/ordena_abajo2.png"  /></a>
      </td>
      <td width="15%" align="center" valign="middle" class="bgtabla"><span class="tabla_encabezado">GRUPO</span>
        <a href="lista_usuarios_baja.php?grupo=<?php echo "D.GRUPO"; ?>&orden=<?php echo "ASC"; ?>"><img class="flechas_ordenar_arriba"  src="../imagenes/ordena_arriba2.png" /></a>
        <a href="lista_usuarios_baja.php?grupo=<?php echo "D.GRUPO"; ?>&orden=<?php echo "DESC"; ?>"><img class="flechas_ordenar_abajo" src="../imagenes/ordena_abajo2.png"  /></a>
      </td>
  ...
  ?>
    <tr class="hover_lista">
      ...
      <td width="8%" align="center" valign="middle" class="boton_modificar" title="MODIFICAR" >
        <a href="modificar_usuario.php?emp_cue=<?php echo $res_datos[CUE]; ?>&r=2"> 
      ...
      <td width="11%" align="center" valign="middle" class="boton_modificar" title="ACTIVAR USUARIO">
      <a href="reingreso_usuario.php?usu_id=<?php echo $res_datos[ID_PERSONA]; ?>">
      <img <?php if($cont[0]==1){ if($res_datos[GRUPO]=="SUPER ADMINISTRADOR"){?> style="visibility:hidden" <?php }} ?> src="../imagenes/reingresar.png" width="27" height="29" /></a></td>
    </tr>
    <?php 
  }
  ?>
