...
<script language="Javascript">
function mi_alerta(){
confirmar=confirm("¿Realmente deseas reingresar al empleado?");
if (confirmar){
location.href = "cambiar_status_empleado.php?emp_id=<?php echo "$emp_id"; ?>&estatus=1";
}
else{
location.href = "empleados_deshabilitados.php";
}
}
</script>
