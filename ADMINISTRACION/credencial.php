...
$pdf->addJpegFromFile('../barras/'.$emp_cue.'.jpg', puntos_cm(11.3), puntos_cm(23)/*,puntos_cm(6.5)*/,puntos_cm(7));
...
//INSERTAR IMAGEN      ruta imagen                       posX           posY         tamañoX       tamañoY
$pdf->addJpegFromFile('../imagenes/credencial_fondo.jpg', puntos_cm(6.5), puntos_cm(22.8),puntos_cm(3)/*,puntos_cm(2)*/);
...
$pdf->addText(puntos_cm(2.5),  puntos_cm(25.4),  13, "NOMBRE:",   0  );
$pdf->addText(puntos_cm(2.5),  puntos_cm(24.7),  17,utf8_decode("<b>$datos[NOMBRE]</b>"),   0  );
$pdf->addText(puntos_cm(2.5),  puntos_cm(24),  17,utf8_decode("<b>$datos[AP_PATERNO]</b>"),   0  );
$pdf->addText(puntos_cm(2.5),  puntos_cm(23.3),  17,utf8_decode("<b>$datos[AP_MATERNO]</b>"),   0  );

$pdf->addText(puntos_cm(2.5),  puntos_cm(22.4),  9, "&Aacute;REA DE TRABAJO:",   0  );
$pdf->addText(puntos_cm(5.6),  puntos_cm(22.4),  10,utf8_decode("<b>$datos2[AREA]</b>"),   0  );
