...
<?php 
$id_proveedor=$_GET['ip'];
$cTp=mysql_query("
SELECT  RAZON_SOCIAL FROM establecimiento
WHERE ID_TIPO_ESTABLECIMIENTO=4
AND ID_MATRIZ=$id_establecimiento
AND ID_ESTABLECIMIENTO=$id_proveedor")
or die("No se pudo hacer la consulta del proveedor. <br/>".mysql_error());
...
<div class="surtir_back">
	<a href="almacen_proveedor.php"><img src="../imagenes/back.png"/></a>
</div>
<div class="surtir_tit stretchRight"><strong>STOCK DE <?php echo $dTp['RAZON_SOCIAL']; ?></strong></div>
</div>
</div>
...
<table width="100%" border="1" class="propTabla ">
  <tr class="bgtabla" >
    ...
    <td align="center" valign="middle">
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "CVE_PRODUCTO"; ?>&orden=<?php echo "ASC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_up"> </div>
     </a>
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "CVE_PRODUCTO"; ?>&orden=<?php echo "DESC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_down"></div>
     </a> 
    </td>
    <td align="center" valign="middle">
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "DESCRIPCION"; ?>&orden=<?php echo "ASC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_up"> </div>
     </a>
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "DESCRIPCION"; ?>&orden=<?php echo "DESC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_down"></div>
     </a>
    </td>
    <td align="left" valign="middle">
    <a href="detalle_almacen_proveedor.php?grupo=<?php echo "PRECIO_COMPRA"; ?>&orden=<?php echo "ASC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_up"> </div>
     </a>
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "PRECIO_COMPRA"; ?>&orden=<?php echo "DESC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_down"></div>
     </a>
    </td>
    <td align="left" valign="middle">
    <a href="detalle_almacen_proveedor.php?grupo=<?php echo "PRECIO_VENTA"; ?>&orden=<?php echo "ASC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_up"> </div>
     </a>
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "PRECIO_VENTA"; ?>&orden=<?php echo "DESC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_down"></div>
     </a>
    </td>
    <td align="left" valign="middle">
    <a href="detalle_almacen_proveedor.php?grupo=<?php echo "DESCUENTO"; ?>&orden=<?php echo "ASC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_up"> </div>
     </a>
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "DESCUENTO"; ?>&orden=<?php echo "DESC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_down"></div>
     </a>
    </td>
    <td align="left" valign="middle">
    <a href="detalle_almacen_proveedor.php?grupo=<?php echo "PRECIO_FINAL"; ?>&orden=<?php echo "ASC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_up"> </div>
     </a>
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "PRECIO_FINAL"; ?>&orden=<?php echo "DESC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_down"></div>
     </a>
    </td>
    <td align="left" valign="middle">
    <a href="detalle_almacen_proveedor.php?grupo=<?php echo "EXISTENCIA"; ?>&orden=<?php echo "ASC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_up"> </div>
     </a>
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "EXISTENCIA"; ?>&orden=<?php echo "DESC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_down"></div>
     </a>
    </td>
    <td align="left" valign="middle">
    <a href="detalle_almacen_proveedor.php?grupo=<?php echo "TOT"; ?>&orden=<?php echo "ASC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_up"> </div>
     </a>
     <a href="detalle_almacen_proveedor.php?grupo=<?php echo "TOT"; ?>&orden=<?php echo "DESC"; ?>&ip=<?php echo $ip; ?>"> 
     <div class="flecha_down"></div>
     </a>
    </td>
  </tr>
  ...
  $alerta2=5;
  $i=0; ?>
  <?php while($rDat=mysql_fetch_array($cRepo)){  $i=$i+1;
   ?>
  ...
  if($rDat['EXISTENCIA'] > $alerta1 && $rDat['EXISTENCIA'] <= $alerta2){
    ...
    <td width="7%"><?php echo $rDat['CVE_PRODUCTO']; ?></td>
    <td width="39%"><?php echo $rDat['DESCRIPCION']; ?></td>
    <td  width="8%" align="right" <?php if($rDat['PRECIO_FINAL']<$rDat['PRECIO_COMPRA']){echo 'bgcolor="#FF0000" style="color:#FFF"';} ?> ><?php echo $rDat['PRECIO_COMPRA']; ?></td>
    <td width="8%" align="right"><?php echo $rDat['PRECIO_VENTA']; ?></td>
    <td width="8%" align="right"><?php echo $rDat['DESCUENTO']." %"; ?></td>
    <td width="8%" align="right" <?php if($rDat['PRECIO_FINAL']<$rDat['PRECIO_COMPRA']){echo 'bgcolor="#FF0000" style="color:#FFF"';} ?> ><?php echo $rDat['PRECIO_FINAL']; ?></td>
    <td width="8%" align="center"><?php echo number_format($rDat['EXISTENCIA'],','); if($rDat['TIPO_PRES_PROD']=='A GRANEL'){echo " Gr.";}?></td>
