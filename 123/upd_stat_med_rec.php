...
$cantidad=1;/*CANTIDAD DEL PRODUCTO A DESCONTAR*/
...
/*HACEMOS UN UPDATE HACIA LA TABLA DE 'inventario' PARA DESCONTAR EL PRODUCTO*/
...
/* BUSCAMOS EN EL CATALOGO DE cat_estatus_activo DONDE EL ESTATUS SEA 'ACTIVO'	*/

$cEstatus=mysql_query("
			SELECT ID_ESTATUS_ACTIVO FROM cat_estatus_activo WHERE ESTATUS_ACTIVO = 'ACTIVO';
					  ")
