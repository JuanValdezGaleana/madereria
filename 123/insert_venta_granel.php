	...
	switch($opc){
		...
		if($cantGr>=250 && $cantGr<=999 ){
			...
			$cVenta=mysql_query("
					...
					'','$clave_venta',$cantGr,NOW(),$id_persona,$id_producto,3,'','',$id_establecimiento,$precio_venta,0
					  )")
		...
		$cVenta=mysql_query("
					INSERT INTO ventas_salidas VALUES(					'','$clave_venta',$cantGr,NOW(),$id_persona,$id_producto,3,'','',$id_establecimiento,$precio_venta,0
					  )")
			or die("
