...
<ul id="menu">
        ...
        <div class="dropdown_3columns align_right"><!-- Begin 3 columns container -->
         ...
         <li class="menu_right">ALMACEN</li>
        <li class="menu_right">REPORTES<!-- Begin 3 columns Item -->
        <div class="dropdown_3columns align_right"><!-- Begin 3 columns container -->
             <div class="col_1">
                <ul class="greybox">
                	 <li>CORTE DIARIO</li>
                     <li>CORTE POR PERIODO</li>
                     <li>CORTE ADMIN.</li>      
                </ul>   
            </div>
        </div><!-- End 3 columns container -->
                ...
                <!-- End 3 columns Item -->
	     <li class="menu_right menu_activo">PUNTO DE VENTA</li>
...
or die("No se pudo hacer la consulta de los resultados.<br/>".mysql_query());
...
<table width="100%" border="1" class="propTabla">
 ...
 while($row=mysql_fetch_array($con)){  ?>             
            ...
            href="insert_venta.php?entra_c=<?php echo $row['CVE_PRODUCTO'] ?>&clave_venta=<?php echo $clave_venta; ?>"><?php echo $row['DESCRIPCION']; ?></a></td>
            <td align="right" valign="middle"><a class="lista_busq" 
            href="insert_venta.php?entra_c=<?php echo $row['CVE_PRODUCTO'] ?>&clave_venta=<?php echo $clave_venta; ?>"><?php echo"$ ". $row['PRECIO_FINAL']; ?></a></td>
          </tr>
 <?php } }?>
</table>
<p>&nbsp;</p>
