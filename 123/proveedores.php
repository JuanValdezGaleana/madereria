...
<fieldset>
<legend>ALTA DE PROVEEDORES</legend>

<form action="insert_proveedor.php" method="post">
<table width="100%" border="0">
  <tr>
    <td width="19%" align="right" valign="top">RAZÓN SOCIAL:</td>
    ...
    <td width="18%" align="right" valign="top">DIRECCIÓN FISCAL:</td>
    <td width="29%" align="left" valign="top"><input name="dir_fiscal" type="text" id="dir_fiscal" size="47"  onchange="javascript:this.value=this.value.toUpperCase();" required="required"/></td>
  </tr>
  <tr>
    <td align="right" valign="top">NOMBRE COMERCIAL:</td>
    <td align="left" valign="top"><input name="nom_comercial" type="text" id="nom_comercial" size="40"  onchange="javascript:this.value=this.value.toUpperCase();" required="required"/></td>
  ...
  <tr>
    ...
    <input name="tipo_establecimiento" id="tipo_establecimiento" type="hidden" value="4" />
...
<table width="100%" border="1" class="propTabla">
 ...
 ?>
  ...
  <tr class="hover_lista">
    <td title="Eliminar"><a href="confirmar_eliminar.php?te=4&i=<?php echo $dP['ID_ESTABLECIMIENTO']; ?>" style="text-decoration:none;"><div class="eliminar">
   X
   </div></a></td>
    ...
    onchange="javascript:this.value=this.value.toUpperCase();"/></td>
      <td><input class="bordes_formulario ancho_form" name="rfc" type="text" <?php echo $cambiar; ?>  value="<?php echo $dP['RFC']; ?>" 
    onchange="javascript:this.value=this.value.toUpperCase();"/></td>
      <td><input class="bordes_formulario ancho_form" name="teltb" type="text" <?php echo $cambiar; ?>   value="<?php echo $dP['TELEFONO']; ?>"
    onchange="javascript:this.value=this.value.toUpperCase();" /></td>
      <td><textarea name="observ" rows="1" class="bordes_formulario ancho_form" <?php echo $cambiar; ?>="<?php echo $cambiar; ?>" onchange="javascript:this.value=this.value.toUpperCase();"><?php echo $dP['OBSERVACIONES']; ?></textarea>
        </td>
      <td align="center"><label>
        <input type="submit" name="modificar" id="modificar" value="Modificar" <?php echo $habilitarBot; ?> />
