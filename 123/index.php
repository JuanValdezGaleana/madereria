...
<div class="lista_productos_vendidos">
 <table width="100%" border="1"  class="propTabla">
  ...
  <form action="update_desc.php" method="post">
    ...
    <td><?php echo $dProdVenta['ID_PRODUCTO'].$dProdVenta['NOMBRE_PRODUCTO'];   ?></td>
    <td align="right">
      <?php echo $dProdVenta['PORCENTAJE_IMPUESTO']; ?>
    </td>
    <td align="right"><label>
      <input name="desc" type="text" id="desc" maxlength="2" style="text-align:center;width:90%; height:90%;" value="<?php echo  number_format($dProdVenta['DESCUENTO'],0); ?>"/>
    </label>      
	...
	if($aux=="A GRANEL"){
		$presUnit=($dProdVenta['PRECIO']/1000)*$dProdVenta['CANTIDAD'];
    ...
    <td align="center" valign="middle">
     <input name="pre_vent" type="hidden" value="<?php echo $dProdVenta['PRECIO']; ?>" />
    <input name="id_prod" type="hidden" value="<?php echo $dProdVenta['ID_PRODUCTO']; ?>" />
    <input name="cv" type="hidden" value="<?php echo $clave_venta; ?>" />
      <input style="width:100%; height:30px; font-size:8px;" type="submit" name="g" id="g" value="Guardar %" />
    </td>
    <td align="center" valign="middle">
	<?php if($_GET['sv']!=1){ ?>
...
<?php } ?> 
 ...
 <table width="100%" border="0" style="height:60px;">
  <tr>
    <td width="37%" align="right"><a style=" text-decoration:none; color:#FFF" href="buscador.php?clave_venta=<?php echo $clave_venta; ?>">
    <input name="clave_venta" type="hidden" value="<?php echo $clave_venta; ?>" />
    E</a>NTRA CÓDIGO:</td>
    <td width="40%"><label>
      <input type="text" name="entra_codigo" id="entra_codigo" <?php echo $bloquear; ?> class="required" onchange="javascript:this.value=this.value.toUpperCase();" autofocus="autofocus" />
      </label>
...
<table width="100%" border="0" height="80px;">
  <tr>
    ...
    <td width="42%"><label>
      ...
      <input name="cantGr" type="number" step="250" min="0" id="cantGr" size="4" <?php echo $bloquear; ?>  style="text-align:right; width:80px;" onkeypress="return justNumbers(event);" placeholder="Cantidad gr." />
      Gr.
      <script type="text/javascript">
...
<?php while($dRecargas=mysql_fetch_array($cRecargas)){ ?>
  <option value="<?php echo $dRecargas['ID_PRODUCTO']; ?>"><?php echo $dRecargas['NOMBRE_PRODUCTO']; ?></option>  
  <?php } ?> 
</select> 
</label>
