...
<table width="100%" border="0">
  ...
  <tr>
    <td valign="top"><label>
      <input type="text" name="busNom" id="busNom" onchange="javascript:this.value=this.value.toUpperCase();"/>
    </label></td>
    </tr>
</table>
...
<form name="form" action="actualizar_lista.php?r=2" method="post">
      ...
      <td align="center" valign="top">
	  <input name="cant_act" type="text" style="width:97%;" readonly="readonly" class="datos bordes_formulario alineacion_numeros" value="<?php  echo $res_datos['CANTIDAD_ACTUAL']  ?>" />
	 </td>
 	  <td valign="top">      
