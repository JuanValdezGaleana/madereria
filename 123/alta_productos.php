  ...
  <table width="100%" border="0">
    ...
    <tr>
	  ...
	  $cTipoPres=mysql_query("
					SELECT ID_TIPO_PRES_PROD,TIPO_PRES_PROD FROM cat_tipo_pres_prod WHERE ID_ESTABLECIMIENTO=$id_establecimiento ORDER BY ID_TIPO_PRES_PROD ASC
								")
    ...
    <tr>
      ...
      <td valign="top"><label>
            ...
            <?php 
	  $cUniMed=mysql_query("
					SELECT ID_UNIDAD_MEDIDA,UNIDAD_MEDIDA,ACRONIMO FROM cat_unidad_medida WHERE ID_ESTABLECIMIENTO=$id_establecimiento ORDER BY ID_UNIDAD_MEDIDA ASC
								")
	  or die("No se pudo consultar los datos de los proveedores. <br/>".mysql_error());
	  ?>
	  ...
	  $cTipoMeds=mysql_query("
					SELECT ID_TIPO_PRODUCTO,TIPO_PRODUCTO FROM cat_tipos_producto WHERE ID_ESTABLECIMIENTO=$id_establecimiento ORDER BY ID_TIPO_PRODUCTO ASC
								")
	  or die("No se pudo consultar los datos de los proveedores. <br/>".mysql_error());
	  ?>
    ...
    <tr>
      <td align="right" valign="top">Descuento:</td>
      <td valign="top"><label>
...
%</label>
      ...
      <td valign="top">
      <label>
<input name="impuesto" type="text" id="impuesto" size="3" style="text-align:right" value="0" onkeyup="porcentaje(precio_venta,descuento,impuesto);" min="0" placeholder="0 ó 16" title="Debes introducir 0 ó 16"/>
%</label>
<datalist id="impuesto">
  <option value="0">
  <option value="16">
</datalist>
     </td>
      <script type="text/javascript">
		            var impuesto = new LiveValidation('impuesto');
		            impuesto.add(Validate.Presence);
					impuesto.add( Validate.Inclusion, { within: [ '0' , '16'] } );
					impuesto.add(Validate.Numericality, { onlyInteger: false } );
		          </script>
    </tr>
    <tr>
      ...
      <td valign="top"><script type="text/javascript">
		            ...
		            <label>$
		              <input type="text" name="precio_final" id="precio_final" value="0" readonly="readonly" />
            </label>
      ...
      <td align="right" valign="top"></td>
      <td valign="top">
       <span style="color:#FF3C41;">(El impuesto debe ser 0 ó 16 )</span>
      </td>
    </tr>
    <tr>
...
<form name="form" action="actualizar_lista.php?r=1" method="post">
      ...
      <!-- INICIO CAMPO  id_tipo_producto -->
	   ...
	   //Consulta para mostrar todos los tipos de productos
	   	$cProducto=mysql_query("SELECT ID_TIPO_PRODUCTO, TIPO_PRODUCTO FROM cat_tipos_producto")
